...
class Player extends SpriteAnimationGroupComponent
  ...
  void _loadAllAnimations() {
    ...
    appearingAnimation = _specialSpriteAnimation('Appearing', 10);
  ...
  // função para criar animação a partir de spritesheet
  ...
  void _updatePlayerState() {
    ...
    // definindo o estado do personagem para correndo
    if (velocity.x > 0 || velocity.x < 0) playerState = PlayerState.running;

    //  definindo o estado do personagem para pulando ou caindo
  ...
  // atualizando a velocidade com base na direção
  ...
  void _respawn() {
    ...
    Future.delayed(hitDuration, () {
      // sempre nascer olhando pra direita
      scale.x = 1;
